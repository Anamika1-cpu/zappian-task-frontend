...
//             <input type="text"  onChange={(e)=>{setEmail(e.target.value)}} placeholder='write your mail here'/>
//             <input type="password"  onChange={(e)=>{setPassword(e.target.value)}} placeholder='write your password here'/>
